...
/* harmony import */ var _modules_about_more_info_more_info__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/about-more-info/more-info */ "./js/modules/about-more-info/more-info.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    form.init();
    window.form = form;
    var submitForm = function submitForm(submitedForm) {
    ...
    var PHONES_INPUT = document.querySelectorAll('[data-validate-type="phone"]');
    PHONES_INPUT.forEach(function (phone) {
      form._initPhoneInput(phone);
    });
    document.querySelectorAll('form').forEach(function (element) {
      element.querySelector('[data-form-submit]').addEventListener('click', submitForm(element));
    });
    if (Object(_modules_accordion_accordion__WEBPACK_IMPORTED_MODULE_3__["initAccardion"])() !== null) {
      Object(_modules_accordion_accordion__WEBPACK_IMPORTED_MODULE_3__["initAccardion"])();
    }
    Object(_modules_about_more_info_more_info__WEBPACK_IMPORTED_MODULE_4__["showMore"])();
  });
});
...
function showMore() {
  var aboutCompany = document.querySelector('[data-about-company]');
  if (aboutCompany) {
    var buttonShowMore = aboutCompany.querySelector('[data-about-button]');
    buttonShowMore.addEventListener('click', function (evt) {
      evt.preventDefault();
      var hideItems = aboutCompany.querySelectorAll('[data-about-bonus-info]');
      var count = 0;
